...
def customize_birthday(the_birthday,
                       the_birthday_srt: str = '',
                       year: int = 1,
                       month: int = 1,
                       day: int = 1):
    """
...
def get_input_integer(the_input,
                      input_text,
                      the_initial_integer,
                      the_last_integer):
    """
...
def instructions(the_content,
                 message='Press any key in order to continue...'):
